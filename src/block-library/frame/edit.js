...
import { SelectControl, ToggleControl,  __experimentalUnitControl as UnitControl } from '@wordpress/components';
...
export default function Edit({
	...
	return (
		<>
			...
			/>
			<TagName className="wp-block-frames-container">
				<div className="wp-block-frames-slider">
					<div { ...innerBlocksProps }>
						{ children }
					</div>
				</div>
				{ blockCount > 0 && Navigation && Navigation.length > 0 && <div className="wp-block-frames-frame wp-block-frames-navigation">
